...
<head>
   ...
   <title>Supplier item list</title>
...
<section class="products">
   ...
   <h1 class="heading">Supplier item list</h1>
   ...
   <div class="box-container">
      ...
      <form action="" method="post">
         <div class="box">
			...
			<h3>Quantity provided: <?php echo $fetch_product['quantity']; ?></h3>
			<h3>Shipping fee: RM<?php echo $fetch_product['shipping']; ?></h3>
