...
if(isset($_POST['add_product'])){
   ...
   $insert_query = mysqli_query($conn, "INSERT INTO `customer`(name, price, quantity, shipping, description, image) VALUES('$p_name', '$p_price', '$p_quantity', '$p_shipping', '$p_description', '$p_image')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `customer` SET name = '$update_p_name', price = '$update_p_price', quantity = '$update_p_quantity', shipping = '$update_p_shipping', description = '$update_p_description',image = '$update_p_image' WHERE id = '$update_p_id'");
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="number" name="p_shipping" min="0" placeholder="Enter the expected shipping fee" class="box" required>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="update requested item" name="update_product" class="btn">
